...
class BallWithWallSoftDynamicsNoDome(DynamicalSystem):
    def __init__(self):
        super().__init__()
        self.h = 0.005      
        self.dim_x = 4
        ...
        self.width = 0.05 # width of the tower
    ...
    def dynamics(self, x):
        ...
        collision, collision_x, collision_y = self.collision_with_bar(p_next_bar)
        if (collision):
            # if it collided from up.
            if (p_now[1] < self.height):
